...
sed -i 's/'"$currentVersion"'/'"$targetVerison"'/g' docker-compose.yaml .github/workflows/homeassistant-installed.yaml README.md www/plantuml/homeassistant-architecture.puml
